...
replace github.com/terraform-providers/terraform-provider-azurerm => github.com/kubeform/terraform-provider-azurerm 7d3fbd3e8f524ddc081d1d78d0aea3a0e85b5bbe
